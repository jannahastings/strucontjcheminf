...
\label{tab:classes}
    Structure-based classes in chemistry are defined using the following features either singly or in composition with other features. 
...
CHEBI:50860  &  organic entity  &  A molecular entity that contains carbon. \\ \hline
